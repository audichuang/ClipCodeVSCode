export const zh: Record<string, string> = {
  ...
  'workbench.commitScopeFailed': '无法读取仓库状态，请点击刷新重试。',
  ...
  'recent.openChanges': '打开所有更改',
  'recent.closeDetails': '关闭详情',
  'recent.loadingFiles': '正在加载更改…',
  'recent.noFiles': '没有文件更改',
  'recent.copyMessage': '复制提交信息',
  'recent.copyFullSource': '复制完整源码',
  'recent.copyPath': '复制路径',
  'recent.openFile': '打开文件',
  'recent.openDiff': '打开更改',
  'recent.parents': '父提交',
  ...
  'reword.message': '提交信息',
  'reword.reword': '修改',
  'reword.rewriteWarning': '修改较早的提交会从该提交起重写历史（此提交及其后所有提交都会获得新的哈希）。',
  'reword.rewritePushedWarning': '该提交似乎已推送。修改会重写历史，需要<span class="modal-emph modal-emph--danger">强制推送</span>，并可能影响协作者。',
  'reword.headPushedWarning': '该提交已推送。修改会重写它，需要<span class="modal-emph modal-emph--danger">强制推送</span>，并可能影响协作者。',
  'amend.title': '修正上一次提交',
  ...
  'diff.prevHunk': '上一个更改',
  'diff.nextHunk': '下一个更改',
  'diff.differences': '此文件共 {count} 处更改',
