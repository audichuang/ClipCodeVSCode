export const en: Record<string, string> = {
  ...
  'graph.reword': 'Reword…',
  'reword.title': 'Reword Commit',
  'reword.message': 'Commit message',
  'reword.reword': 'Reword',
  'reword.rewriteWarning': 'Rewording an earlier commit rewrites history from it forward (this commit and every descendant get new hashes).',
  'reword.rewritePushedWarning': 'This commit appears to be pushed. Rewording rewrites history and will require a <span class="modal-emph modal-emph--danger">force-push</span>, affecting collaborators.',
  'reword.headPushedWarning': 'This commit is already pushed. Rewording rewrites it and will require a <span class="modal-emph modal-emph--danger">force-push</span>, affecting collaborators.',
