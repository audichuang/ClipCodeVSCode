export const ko: Record<string, string> = {
  ...
  'toolbar.stashDesc': '스태시 (커밋되지 않은 변경 사항 저장)',
  'toolbar.fetchAll': '모두 가져오기 (원격 변경 사항 다운로드)',
  'toolbar.pullDesc': '당겨오기 (가져오기 + 병합)',
  ...
  'toolbar.detachedHead': '(분리된 HEAD)',
  'error.detachedPushPull': '브랜치에 있지 않습니다(분리된 HEAD) — 푸시/풀 전에 브랜치를 체크아웃하세요.',
  ...
  'push.cancel': '취소',
  'push.push': '푸시',
  'push.forcePushBtn': '강제 푸시',
  'push.branch': '브랜치',
  'push.to': '대상',
  'push.new': '새 항목 ({target})',
  ...
  'workbench.commitScopeFailed': '리포지토리 상태를 읽을 수 없습니다 — 새로 고침으로 다시 시도하세요.',
  ...
  'stash.keepIndex': '스테이징된 변경 사항 유지',
  'stash.stash': '스태시',
  ...
  // Graph
  'graph.uncommitted': '커밋되지 않은 변경 ({staged}개 스테이징됨, {unstaged}개 미스테이징)',
  ...
  'graph.stash': '변경 사항 스태시',
  'graph.amendCommit': '커밋 수정',
  'graph.reword': '메시지 수정…',
  'reword.title': '커밋 메시지 수정',
  'reword.message': '커밋 메시지',
  'reword.reword': '수정',
  'reword.rewriteWarning': '이전 커밋의 메시지를 수정하면 해당 커밋부터 히스토리가 다시 작성됩니다(이 커밋과 모든 자식 커밋의 해시가 바뀝니다).',
  'reword.rewritePushedWarning': '이 커밋은 이미 푸시된 것으로 보입니다. 수정은 히스토리를 다시 작성하므로 <span class="modal-emph modal-emph--danger">force-push</span>가 필요하며 협업자에게 영향을 줍니다.',
  'reword.headPushedWarning': '이 커밋은 이미 푸시되었습니다. 수정은 이를 다시 작성하므로 <span class="modal-emph modal-emph--danger">force-push</span>가 필요하며 협업자에게 영향을 줍니다.',
  ...
  'graph.commitFixup': 'Fixup 커밋 생성',
  'graph.commitSquash': 'Squash 커밋 생성',
  ...
  'reset.soft': 'Soft',
  'reset.softDesc': '모든 변경 사항을 스테이징된 상태로 유지',
  'reset.mixed': 'Mixed',
  'reset.mixedDesc': '변경 사항은 유지하되 스테이징 해제',
  'reset.hard': 'Hard',
  ...
  'details.staged': '스테이징됨',
  'details.unstaged': '미스테이징',
  'details.author': '작성자',
  ...
  'search.branchFilter': '브랜치',
  'search.branchFilterTooltip': '특정 브랜치로 필터',
  'search.allBranches': '전체',
  ...
  'reset.softOption': 'Soft - 모든 변경 사항을 스테이징된 상태로 유지',
  'reset.mixedOption': 'Mixed - 모든 변경 사항을 스테이징 해제 상태로 유지',
